...
public class WikimediaEventHandler implements EventHandler {
    ...
    private final static Logger log = LoggerFactory.getLogger(WikimediaEventHandler.class);
    ...
    public void onMessage(String event, MessageEvent messageEvent) throws Exception {
        ...
        kafkaProducer.send(new ProducerRecord<>(topic,event,messageEvent.getData()));
    }
    ...
    public void onError(Throwable t) {
        log.error("Error when handling messages", t);
    }
}
